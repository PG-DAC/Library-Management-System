...
query="insert into category (" + "category_name," + "profile," + "added_on" + ") values(?,?,?)";
ps=connection.prepareStatement(query);
ps.setString(1,category_name);
...
query="insert into author (" + "author_name," + "profile," + "added_on" + ") values(?,?,?)";
ps=connection.prepareStatement(query);
ps.setString(1,author_name);
ps.setString(2,profile);
ps.setString(3,added_on);
...
query="insert into publisher (" + "publisher_name," + "profile," + "added_on" + ") values(?,?,?)";
ps=connection.prepareStatement(query);
ps.setString(1,publisher_name);
ps.setString(2,profile);
ps.setString(3,added_on);
