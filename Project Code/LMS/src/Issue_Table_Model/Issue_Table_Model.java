...
String query="update issue_book set " + "issue_date=?," + "renew_date1=?," + "renew_date2=?," + "renew_date3=?," + "renew_date4=?," +
									"renew_date5=?," + "return_date=?," + "returned_date=?," + "status=?," + "description=? where issue_sl_no=?  ";
...
query="update serial_number set " + "book_status=? " + "where bar_code=?";
ps=connection.prepareStatement(query);
...
query="insert into issue_book(" + "student_id," + "admission_no," + "student_name," + "book_title," + "book_sl_no," + "barcode," +
							  "issue_date," + "return_date," + "status,issue_sl_no,description) values(?,?,?,?,?,?,?,?,?,?,?)";
					ps=connection.prepareStatement(query);
...
query="insert into issue_book(" + "student_id," + "admission_no," + "student_name," + "book_title," + "book_sl_no," + "barcode," + "issue_date," +
							"return_date," + "status,issue_sl_no,description) values(?,?,?,?,?,?,?,?,?,?,?)";
...
List<Issue_Use_Bean> list=new ArrayList<Issue_Use_Bean>();
try { 
String query="select * from issue_book where " + "admission_no like ? or " + "student_name like ? or " + "book_title like ? or " + "barcode like ? or " +
					   "issue_date like ? or " + "renew_date1 like ? or " + "renew_date2 like ? or " + "renew_date3 like ? or " + "renew_date4 like ? or " +
					   "renew_date5 like ? or " + "return_date like ? or " + "returned_date like ? or " + "status like ? or " +
